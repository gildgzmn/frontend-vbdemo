  ...
  return (
    <div className="relative landing-page">
      ...
      <div className="bg-gray-100 py-8">
        ...
        <div className="bg-gray-800 py-8 grid grid-cols">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8"></div>
          <motion.div className="bg-white p-4 rounded-lg shadow-lg" whileHover={{ scale: 1.02 }}>
            <h3 className="text-xl font-semibold mb-4 text-center">Recruitment Percentage Per Municipality</h3>
            <div className="mb-4 text-center">
              <MainDashBoard />
            </div>
